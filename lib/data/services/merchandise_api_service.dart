...
class MerchandiseApiService extends BaseAPIService {
  ...
  Future<List<MerchantModel>> fetchRecommends() async {
     final response = await http.get(Uri.parse("https://www.datacenter.com/merchandises"), headers: getDefaultHeader());
     try {
       responseValidation(response);
       List<dynamic> jsonModel = json.decode(response.body);
       List<MerchantModel> responseItems = jsonModel.map((data) => MerchantModel.fromJson(data)).toList();
